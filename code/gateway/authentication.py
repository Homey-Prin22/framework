...
def verify_token(
    ...
    def decorator(f):
        @wraps(f)
        @jwt_required(optional, fresh, refresh, locations, verify_type, skip_revocation_check=True)
        def decorator_function(*args, **kwargs):
            ...
            # The combination !optional && null_token is not possible (checked in jwt_required)
